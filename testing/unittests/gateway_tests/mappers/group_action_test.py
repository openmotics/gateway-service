...
class GroupActionCoreMapperTest(unittest.TestCase):
    ...
    def test_mappings(self):
        normal_scenarios = [([160, 5], [(0, 0, 5)]),  # Turn output 5 off
                            ...
                            ([240, 0, 247, 228, 249, 10, 240, 255], [(100, 0), (100, 40, 0, 10), (100, 255)]),  # If hour > 10
                            ([240, 0, 247, 229, 248, 10, 240, 255], [(100, 0), (100, 44, 0, 10), (100, 255)]),  # If minutes == 10
                            ([240, 0, 247, 230, 250, 3, 240, 255], [(100, 0), (100, 48, 0, 3), (100, 255)]),  # If day < 3
