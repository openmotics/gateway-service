...
def migrate(migrator, database, fake=False, **kwargs):
    ...
    for thermostat in Thermostat.select(Thermostat, ThermostatGroup) \
                                .join_from(Thermostat, ThermostatGroup):
        thermostat.state = 'on' if thermostat.thermostat_group.on else 'off'
        thermostat.save()

    migrator.remove_fields(ThermostatGroup, 'on')
