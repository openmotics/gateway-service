                ...
                for realtime_p1 in realtime_p1_data:
                    if str(realtime_p1['module_id']) == module_id:
                        self._enqueue_metrics(metric_type='energy_p1',
                                              values={'timestamp': realtime_p1['timestamp'],
                                                      'consumption_gas': realtime_p1['gas'],
                                                      'tariff1': realtime_p1['tariff']['tariff1'],
                                                      'tariff2': realtime_p1['tariff']['tariff2'],
                                                      'tariff_indicator': realtime_p1['tariff']['indicator'],
                                                      'voltage_phase1': realtime_p1['voltage']['phase1'],
