...
class GlobalConfiguration(GlobalMemoryModelDefinition):
    ...
    number_of_output_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 1), default=0)  # 0, 1
    number_of_input_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 2), default=0)  # 0, 2
    number_of_sensor_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 3), default=0)  # 0, 3
    scan_time_rs485_sensor_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 4), default=50)  # 0, 4
    ...
    number_of_ucan_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 7), default=0)  # 0, 7
    scan_time_rs485_bus = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 8), default=8)  # 0, 8
    number_of_can_control_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 9), default=0)  # 0, 9
    scan_time_rs485_can_control_modules = MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 10), default=50)  # 0, 10
...
class OutputModuleConfiguration(MemoryModelDefinition):
    ...
    id = IdField(limits=lambda f: (0, f - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 1), default=0))
...
class OutputConfiguration(MemoryModelDefinition):
    ...
    id = IdField(limits=lambda f: (0, f * 8 - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 1), default=0))
...
class InputModuleConfiguration(MemoryModelDefinition):
    id = IdField(limits=lambda f: (0, f - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 2), default=0))
...
class InputConfiguration(MemoryModelDefinition):
    ...
    id = IdField(limits=lambda f: (0, f * 8 - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 2), default=0))
...
class SensorModuleConfiguration(MemoryModelDefinition):
    id = IdField(limits=lambda f: (0, f - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 3), default=0))
...
class SensorConfiguration(MemoryModelDefinition):
    ...
    id = IdField(limits=lambda f: (0, f * 8 - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 3), default=0))
...
class ShutterConfiguration(MemoryModelDefinition):
    ...
    id = IdField(limits=lambda f: (0, min(256, f * 4) - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 1), default=0))
...
class CanControlModuleConfiguration(MemoryModelDefinition):
    id = IdField(limits=lambda f: (0, f - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 9), default=0))
...
class UCanModuleConfiguration(MemoryModelDefinition):
    ...
    id = IdField(limits=lambda f: (0, f - 1), field=MemoryByteField(MemoryTypes.EEPROM, address_spec=(0, 7), default=0))
