...
class MemoryFile(object):
    ...
    def _load_data(self, read_map, bypass_read_cache):
        ...
        for page in read_map.get(MemoryTypes.EEPROM, set()):
            if page not in self._eeprom_cache or bypass_read_cache:
        ...
        for page in read_map.get(MemoryTypes.FRAM, set()):
            if page not in self._fram_cache or self._fram_cache[page][0] < time_limit or bypass_read_cache:
